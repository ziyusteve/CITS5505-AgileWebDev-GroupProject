...
def health_check():
    ...
    # Return 200 if everything is OK, 503 if any service has issues
        ...
        if analysis.analysis_result:
            try:
                ...
                current_app.logger.error(
                    f"Error parsing analysis result JSON: {str(e)}"
                )
        ...
        return jsonify(
            {
                ...
                "config_enabled": current_app.config.get(
                    "ENABLE_SCOUT_ANALYSIS", False
                ),
                "test_result": result,
